...
class AppColors {
    ...
    // static let SettingBackgroundColor = Color(hex: "19191A")
    // static let SettinglistRowBackground = Color(hex: "292929");

    static let SettingBackgroundColor = Color(hex: "292929")
